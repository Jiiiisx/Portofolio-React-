...
const DEFAULT_GLOW_COLOR = '86, 130, 177';
...
const BentoCardGrid: React.FC<{
  ...
  <div
    className="bento-section grid gap-4 p-3 max-w-[70rem] mx-auto min-h-screen select-none relative"
  ...
  return (
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        <div className="card-responsive grid gap-4" style={{ width: "100%", margin: 0 }}>
